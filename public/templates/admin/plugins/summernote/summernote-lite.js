      ...
      return this.ui.buttonGroup({
        ...
        children: [this.button({
          ...
          click: function click(event) {
            event.stopPropagation();
            var $parent = external_jQuery_default()('.' + className).find('.note-dropdown-product');
...
(external_jQuery_default()).summernote = external_jQuery_default().extend((external_jQuery_default()).summernote, {
  ...
  options: {
    ...
    icons: {
      ...
      'menuCheck': 'note-icon-product-check',
...
external_jQuery_default()(document).on('click.note-dropdown-product', function (e) {
  external_jQuery_default()(e.target).closest('.note-dropdown-product').parent().removeClass('open');
  external_jQuery_default()(e.target).closest('.note-dropdown-product').parent().find('.note-btn.active').removeClass('active');
});
...
var dropdown = renderer.create('<div class="note-dropdown-product" role="list"></div>', function ($node, options) {
...
var dropdownCheck = renderer.create('<div class="note-dropdown-product note-check" role="list"></div>', function ($node, options) {
  var markup = Array.isArray(options.items) ? options.items.map(function (item) {
    var value = typeof item === 'string' ? item : item.value || '';
    var content = options.template ? options.template(item) : item;
