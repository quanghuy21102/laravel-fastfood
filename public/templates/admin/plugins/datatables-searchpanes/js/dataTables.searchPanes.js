...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
         ...
         *
         * @param display the value to be displayed to the customer
        ...
        SearchPane.prototype._setListeners = function () {
            ...
            this.s.dtPane.off('customer-select.dtsp');
            this.s.dtPane.on('customer-select.dtsp', function (e, _dt, type, cell, originalEvent) {
                ...
                columnDefs: [
                    {
                        ...
                        // This is null if not defined by the customer, meaning that automatic type detection
                        //  would take place
         ...
         *
         * @returns {object} The options for the row extended to include the options from the customer.
         */
