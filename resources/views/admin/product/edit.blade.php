    ...
    <div class="card-body">
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="form-group d-flex align-items-center justify-content-center">
                <div id="image_show">
                    <a href="{{ asset($product->image_path) }}" target="_blank">
                        <img src="{{ asset($product->image_path) }}" width="100px" alt="{{ $product->product_name }}">
                    </a>
                </div>
                <input type="hidden" name="image_path" value="{{ $product->image_path }}" id="image_path">
            </div>
            <div class="form-group d-flex align-items-center justify-content-center">
            ...
            <div class="form-group d-flex align-items-center justify-content-center">
                ...
                <input class="form-control w-50" type="text" name="product_name" value="{{ $product->product_name }}" placeholder="Nhập tên sản phẩm">
            </div>
            <div class="form-group d-flex align-items-center justify-content-center">
                <label class="m-0 px-3" for="">Giá tiền</label>
                <input class="form-control w-50" type="number" name="price" value="{{ $product->price }}" placeholder="Nhập giá tiền">
            </div>
            <div class="form-group d-flex align-items-center justify-content-center">
